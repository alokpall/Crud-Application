...
function insertNewRecord(data){
    ...
    var cell2 =newRow.insertCell(1);
         cell2.innerHTML =data.StudenSection;
...
function onEdit(td){
    ...
    document.getElementById('StudenSection').value = selectedRow.cells[1].innerHTML;
...
function updateRecord(formData){
    ...
    selectedRow.cells[1].innerHTML = formData.StudentSection;
